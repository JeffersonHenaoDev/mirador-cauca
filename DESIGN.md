...
## Colors
- **Primary (`#442D24`):** Forest green — actions, navigation, interactive states.
- **Background (`#F4F4F4`):** Warm gray — diferent, never sterile white.
- **2 Background (`#E7C7AC`):** Warm cream — organic, never sterile white.
- **Tertiary (`#DE8B00`):** Warm amber — highlights, accents, badges.
- **Texts (`#2A2E33`)** Parragraphs and titles, all text over white background
